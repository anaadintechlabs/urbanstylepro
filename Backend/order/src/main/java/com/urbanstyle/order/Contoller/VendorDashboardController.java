...
public class VendorDashboardController {
	...
	public Map<String,Object> getLastOrdersForVendor(@RequestParam(value="offset")int offset,@RequestParam(value="vendorId")long vendorId,HttpServletRequest request,
